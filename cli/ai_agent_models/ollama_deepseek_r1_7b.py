...
from ..utils.formatting import print_error, print_info, loading_spinner
...
class OllamaDeepSeekModel(BaseAIModel):
        ...
        **kwargs
        ...
        try:
            if not stream:
                ...
                with loading_spinner(f"Generating text with {self.model_name}...", spinner_style="moon"):
    ...
    def generate_code(
        ...
        **kwargs
        ...
        system_prompt = f"You are an expert {language} programmer. Generate high-quality, working code that addresses the user's request. Include comments to explain key parts. Only output code, no explanations."
    ...
    def _process_think_tags(self, text: str) -> str:
        ...
        thinking_sections = self._extract_thinking_sections(text)
